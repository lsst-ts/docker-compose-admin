...
if [ $# -lt 1 ]; then
  cscs="ledprojector fiberspectrograph_red electrometer1 electrometer2 electrometer3 electrometer4 electrometer5 electrometer6 laser cbp fiberspectrograph_blue"
else
  cscs="$1"
fi
